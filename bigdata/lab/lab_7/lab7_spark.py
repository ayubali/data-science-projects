...
if __name__ == '__main__':
    sc = SparkContext()
    rdd = sc.textFile("/data/share/bdm/yellow.csv.gz")
    rdd1 = sc.textFile("/data/share/bdm/citibike.csv")
    rdd1 = rdd1.mapPartitionsWithIndex(filterBike)
    rdd = rdd.mapPartitionsWithIndex(filterTaxi)
    count = (rdd1+rdd).sortByKey().mapPartitionsWithIndex(connectTrips) \
